var q_matrix = function() {
  ...
  self.xRotation = function(angleInRadians) {
  ...
  self.yRotation = function(angleInRadians) {
    var c = Math.cos(angleInRadians);
    var s = Math.sin(angleInRadians);
  ...
  self.zRotation = function(angleInRadians) {
    var c = Math.cos(angleInRadians);
    var s = Math.sin(angleInRadians);
  ...
  self.multiplySeries = function () {
    if (arguments.length >= 3) {
      arguments[0] = self.multiply(arguments[0], arguments[1], arguments[2]);
      var j;
      for (j = 3; j < arguments.length; j += 1) {
        arguments[0] = self.multiply(arguments[0], arguments[0], arguments[j]);
      }
      return arguments[0];
    }
  };
